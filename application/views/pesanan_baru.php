            ...
            <div class="card card-outline card-primary">
              ...
              <div class="card-body">
                <table id="example" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    <?php 
                        $pesan = $this->pesanan_model->get_pesanan_baru();
                        $n = 0;
                    ...
                    ?>
                        <tr>
                            ...
                            <td style="text-align:center"><a href="<?php echo site_url("pesanan/baru/detail?id=".$row->id) ?>" class="btn-shadow btn btn-success">Detail</a></td>
                        </tr>
                    <?php } ?>
                  </tbody>
                  <tfoot>
